...
.method public bridge synthetic i(Lz/a;F)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lp/l;->p(Lz/a;F)Lz/d;
...
.method public p(Lz/a;F)Lz/d;
    ...
    :cond_0
    iget-object p1, p0, Lp/l;->i:Lz/d;

    invoke-virtual {v0}, Lz/d;->b()F

    move-result v2

    invoke-virtual {v1}, Lz/d;->b()F

    move-result v3

    invoke-static {v2, v3, p2}, Ly/g;->i(FFF)F
    ...
    invoke-virtual {v1}, Lz/d;->c()F

    move-result v1

    invoke-static {v0, v1, p2}, Ly/g;->i(FFF)F

    move-result p2

    invoke-virtual {p1, v2, p2}, Lz/d;->d(FF)V

    iget-object p0, p0, Lp/l;->i:Lz/d;

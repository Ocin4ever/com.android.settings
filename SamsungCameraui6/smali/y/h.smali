...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Ly/h;->a:Ljava/lang/ThreadLocal;

    new-instance v0, Ly/h$b;

    invoke-direct {v0}, Ly/h$b;-><init>()V

    sput-object v0, Ly/h;->b:Ljava/lang/ThreadLocal;

    new-instance v0, Ly/h$c;

    invoke-direct {v0}, Ly/h$c;-><init>()V

    sput-object v0, Ly/h;->c:Ljava/lang/ThreadLocal;

    new-instance v0, Ly/h$d;

    invoke-direct {v0}, Ly/h$d;-><init>()V

    sput-object v0, Ly/h;->d:Ljava/lang/ThreadLocal;
...
.method public static a(Landroid/graphics/Path;FFF)V
    ...
    sget-object v1, Ly/h;->a:Ljava/lang/ThreadLocal;
    ...
    sget-object v2, Ly/h;->b:Ljava/lang/ThreadLocal;
    ...
    sget-object v3, Ly/h;->c:Ljava/lang/ThreadLocal;
    ...
    invoke-static {v5, v4}, Ly/g;->f(FF)I

    move-result p2

    int-to-float v5, p2

    invoke-static {p1, v4}, Ly/g;->f(FF)I
...
.method public static b(Landroid/graphics/Path;Lo/u;)V
    .locals 3

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lo/u;->k()Z
    ...
    invoke-virtual {p1}, Lo/u;->h()Lp/a;

    move-result-object p1

    check-cast p1, Lp/d;

    invoke-virtual {p1}, Lp/d;->p()F
    ...
    invoke-static {p0, v0, v1, p1}, Ly/h;->a(Landroid/graphics/Path;FFF)V
...
.method public static g(Landroid/graphics/Matrix;)F
    ...
    sget-object v0, Ly/h;->d:Ljava/lang/ThreadLocal;
...
.method public static m(Landroid/graphics/Canvas;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    invoke-static {p0, p1, p2, v0}, Ly/h;->n(Landroid/graphics/Canvas;Landroid/graphics/RectF;Landroid/graphics/Paint;I)V

...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lg0/d;->e:Ljava/lang/Object;

    new-instance v0, Lg0/d;

    invoke-direct {v0}, Lg0/d;-><init>()V

    sput-object v0, Lg0/d;->f:Lg0/d;
...
.method public static k()Lg0/d;
    .locals 1

    sget-object v0, Lg0/d;->f:Lg0/d;
...
.method public a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-super {p0, p1, p2, p3}, Lg0/e;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
...
.method public b(Landroid/content/Context;II)Landroid/app/PendingIntent;
    ...
    invoke-super {p0, p1, p2, p3}, Lg0/e;->b(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public final d(I)Ljava/lang/String;
    ...
    invoke-super {p0, p1}, Lg0/e;->d(I)Ljava/lang/String;
...
.method public e(Landroid/content/Context;)I
    ...
    invoke-super {p0, p1}, Lg0/e;->e(Landroid/content/Context;)I
...
.method public f(Landroid/content/Context;I)I
    ...
    invoke-super {p0, p1, p2}, Lg0/e;->f(Landroid/content/Context;I)I
...
.method public final h(I)Z
    ...
    invoke-super {p0, p1}, Lg0/e;->h(I)Z
...
.method public i(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lg0/d;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    invoke-static {p1, v0, p3}, Lj0/a0;->b(Landroid/app/Activity;Landroid/content/Intent;I)Lj0/a0;

    move-result-object p3

    invoke-virtual {p0, p1, p2, p3, p4}, Lg0/d;->n(Landroid/content/Context;ILj0/a0;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public j(Landroid/content/Context;Lg0/a;)Landroid/app/PendingIntent;
    .locals 1

    invoke-virtual {p2}, Lg0/a;->e()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p2}, Lg0/a;->d()Landroid/app/PendingIntent;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lg0/d;->b(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public l(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Z
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lg0/d;->i(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lg0/d;->q(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public m(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0, p1, p2, v0, v1}, Lg0/e;->c(Landroid/content/Context;IILjava/lang/String;)Landroid/app/PendingIntent;

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {p0, p1, p2, v1, v0}, Lg0/d;->r(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V

    return-void
.end method

.method public final n(Landroid/content/Context;ILj0/a0;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 4
    ...
    :cond_2
    invoke-static {p1, p2}, Lj0/x;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p1, p2}, Lj0/x;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_4
    invoke-static {p1, p2}, Lj0/x;->g(Landroid/content/Context;I)Ljava/lang/String;
...
.method public final o(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, v0}, Lj0/x;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v0, v1, p2}, Lg0/d;->q(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V

    return-object v0
.end method

.method public final p(Landroid/content/Context;Li0/e0;)Li0/f0;
    .locals 2
    ...
    invoke-direct {v1, p2}, Li0/f0;-><init>(Li0/e0;)V

    invoke-static {p1, v1, v0}, Lq0/f;->a(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    invoke-virtual {v1, p1}, Li0/f0;->a(Landroid/content/Context;)V

    const-string v0, "com.google.android.gms"

    invoke-virtual {p0, p1, v0}, Lg0/e;->g(Landroid/content/Context;Ljava/lang/String;)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-virtual {p2}, Li0/e0;->a()V

    invoke-virtual {v1}, Li0/f0;->b()V
...
.method public final q(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-static {p2, p4}, Lg0/j;->d(Landroid/app/Dialog;Landroid/content/DialogInterface$OnCancelListener;)Lg0/j;

    move-result-object p1

    invoke-virtual {p1, p0, p3}, Lg0/j;->show(Landroidx/fragment/app/FragmentManager;Ljava/lang/String;)V
    ...
    invoke-static {p2, p4}, Lg0/b;->a(Landroid/app/Dialog;Landroid/content/DialogInterface$OnCancelListener;)Lg0/b;

    move-result-object p1

    invoke-virtual {p1, p0, p3}, Lg0/b;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
...
.method public final r(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-virtual {p0, p1}, Lg0/d;->s(Landroid/content/Context;)V
    ...
    :cond_2
    invoke-static {p1, p2}, Lj0/x;->f(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v0

    invoke-static {p1, p2}, Lj0/x;->e(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {p1}, Ln0/d;->b(Landroid/content/Context;)Z

    move-result v6

    if-eqz v6, :cond_4

    invoke-static {}, Ln0/e;->c()Z

    move-result v1

    invoke-static {v1}, Lj0/n;->i(Z)V
    ...
    invoke-static {p4}, Lj0/n;->i(Z)V

    sget-object p4, Lg0/d;->e:Ljava/lang/Object;
    ...
    invoke-static {p1}, Lj0/x;->b(Landroid/content/Context;)Ljava/lang/String;
    ...
    :cond_8
    sget-object p1, Lg0/g;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final s(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0, p1}, Lg0/k;-><init>(Lg0/d;Landroid/content/Context;)V
...
.method public final t(Landroid/app/Activity;Li0/g;IILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 1

    const-string p4, "d"

    invoke-virtual {p0, p1, p3, p4}, Lg0/d;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object p4

    const/4 v0, 0x2

    invoke-static {p2, p4, v0}, Lj0/a0;->c(Li0/g;Landroid/content/Intent;I)Lj0/a0;

    move-result-object p2

    invoke-virtual {p0, p1, p3, p2, p5}, Lg0/d;->n(Landroid/content/Context;ILj0/a0;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-virtual {p0, p1, p2, p3, p5}, Lg0/d;->q(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public final u(Landroid/content/Context;Lg0/a;I)Z
    .locals 4

    invoke-static {p1}, Lo0/a;->a(Landroid/content/Context;)Z
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lg0/d;->j(Landroid/content/Context;Lg0/a;)Landroid/app/PendingIntent;
    ...
    invoke-virtual {p0, p1, p2, v0, p3}, Lg0/d;->r(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V

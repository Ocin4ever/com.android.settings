.class Lcom/sec/android/app/camera/engine/CaptureLoggingController;
...
.field private mCaptureLoggingEventListener:Lcom/sec/android/app/camera/interfaces/Engine$CaptureLoggingEventListener;
...
.method public constructor <init>(Lcom/sec/android/app/camera/engine/CommonEngine;)V
    ...
    iput-object p1, p0, Lcom/sec/android/app/camera/engine/CaptureLoggingController;->mEngine:Lcom/sec/android/app/camera/engine/CommonEngine;
    ...
    iput-object p1, p0, Lcom/sec/android/app/camera/engine/CaptureLoggingController;->mCameraSettings:Lcom/sec/android/app/camera/interfaces/CameraSettings;

    return-void
.end method

.method public static synthetic a(Lcom/sec/android/app/camera/interfaces/SaLogEventId;)V
    .locals 0

    invoke-static {p0}, Lcom/sec/android/app/camera/engine/CaptureLoggingController;->lambda$sendCaptureLoggingBackground$0(Lcom/sec/android/app/camera/interfaces/SaLogEventId;)V

    return-void
.end method

.method public static synthetic b(Lcom/sec/android/app/camera/engine/CaptureLoggingController;Ljava/util/HashMap;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/camera/engine/CaptureLoggingController;->lambda$updateLoggingDataBackground$1(Ljava/util/HashMap;)V
...
.method private getEventId()Lcom/sec/android/app/camera/interfaces/SaLogEventId;
    ...
    iget-object p0, p0, Lcom/sec/android/app/camera/engine/CaptureLoggingController;->mCameraSettings:Lcom/sec/android/app/camera/interfaces/CameraSettings;
...
.method private synthetic lambda$updateLoggingDataBackground$1(Ljava/util/HashMap;)V
    ...
    iget-object p0, p0, Lcom/sec/android/app/camera/engine/CaptureLoggingController;->mCaptureLoggingEventListener:Lcom/sec/android/app/camera/interfaces/Engine$CaptureLoggingEventListener;

    if-eqz p0, :cond_0

    invoke-interface {p0}, Lcom/sec/android/app/camera/interfaces/Engine$CaptureLoggingEventListener;->onCaptureLoggingRequested()V
...
.method private sendCaptureLoggingBackground(Lcom/sec/android/app/camera/interfaces/SaLogEventId;)V
    ...
    iget-object p0, p0, Lcom/sec/android/app/camera/engine/CaptureLoggingController;->mEngine:Lcom/sec/android/app/camera/engine/CommonEngine;
    ...
    new-instance v0, Lcom/sec/android/app/camera/engine/s2;

    invoke-direct {v0, p1}, Lcom/sec/android/app/camera/engine/s2;-><init>(Lcom/sec/android/app/camera/interfaces/SaLogEventId;)V
...
.method private updateLoggingDataBackground(Ljava/util/HashMap;)V
    ...
    iget-object v0, p0, Lcom/sec/android/app/camera/engine/CaptureLoggingController;->mEngine:Lcom/sec/android/app/camera/engine/CommonEngine;
    ...
    new-instance v1, Lcom/sec/android/app/camera/engine/t2;

    invoke-direct {v1, p0, p1}, Lcom/sec/android/app/camera/engine/t2;-><init>(Lcom/sec/android/app/camera/engine/CaptureLoggingController;Ljava/util/HashMap;)V
...
.method public sendCaptureLogging()V
    ...
    invoke-direct {p0}, Lcom/sec/android/app/camera/engine/CaptureLoggingController;->getEventId()Lcom/sec/android/app/camera/interfaces/SaLogEventId;

    move-result-object v0

    invoke-direct {p0, v0}, Lcom/sec/android/app/camera/engine/CaptureLoggingController;->sendCaptureLoggingBackground(Lcom/sec/android/app/camera/interfaces/SaLogEventId;)V
...
.method public setCaptureLoggingEventListener(Lcom/sec/android/app/camera/interfaces/Engine$CaptureLoggingEventListener;)V
    ...
    iput-object p1, p0, Lcom/sec/android/app/camera/engine/CaptureLoggingController;->mCaptureLoggingEventListener:Lcom/sec/android/app/camera/interfaces/Engine$CaptureLoggingEventListener;
...
.method public updateCaptureLogging()V
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/engine/CaptureLoggingController;->mEngine:Lcom/sec/android/app/camera/engine/CommonEngine;
    ...
    invoke-direct {p0, v1}, Lcom/sec/android/app/camera/engine/CaptureLoggingController;->getDynamicShotModeString(Lcom/samsung/android/camera/core2/container/DynamicShotInfo;)Ljava/lang/String;
    ...
    invoke-direct {p0, v1}, Lcom/sec/android/app/camera/engine/CaptureLoggingController;->getDynamicShotConditionString(Lcom/samsung/android/camera/core2/container/DynamicShotInfo;)Ljava/lang/String;
    ...
    invoke-direct {p0, v1}, Lcom/sec/android/app/camera/engine/CaptureLoggingController;->getDynamicShotDeviceInfoString(Lcom/samsung/android/camera/core2/container/DynamicShotInfo;)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v2, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v1, p0, Lcom/sec/android/app/camera/engine/CaptureLoggingController;->mCameraSettings:Lcom/sec/android/app/camera/interfaces/CameraSettings;
    ...
    iget-object v2, p0, Lcom/sec/android/app/camera/engine/CaptureLoggingController;->mEngine:Lcom/sec/android/app/camera/engine/CommonEngine;

    invoke-virtual {v2}, Lcom/sec/android/app/camera/engine/CommonEngine;->getOrientationForCapture()I

    move-result v2

    iget-object v3, p0, Lcom/sec/android/app/camera/engine/CaptureLoggingController;->mEngine:Lcom/sec/android/app/camera/engine/CommonEngine;
    ...
    :cond_0
    invoke-direct {p0, v0}, Lcom/sec/android/app/camera/engine/CaptureLoggingController;->updateLoggingDataBackground(Ljava/util/HashMap;)V

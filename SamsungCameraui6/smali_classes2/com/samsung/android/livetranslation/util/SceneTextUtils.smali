...
.method public static constructor <clinit>()V
    ...
    sput-object v1, Lcom/samsung/android/livetranslation/util/SceneTextUtils;->adjustmentX:[I
...
.method public static makeOneParagraph(Ljava/util/concurrent/CopyOnWriteArrayList;)Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-virtual {v15}, Lcom/samsung/android/livetranslation/text/SceneText;->clone()Lcom/samsung/android/livetranslation/text/SceneText;

    move-result-object v4

    invoke-virtual {v2, v4}, Lcom/samsung/android/livetranslation/text/SceneText;->setComponent(Lcom/samsung/android/livetranslation/text/SceneText;)V

    const/16 v4, 0xa

    invoke-virtual {v5, v4}, Ljava/lang/StringBuffer;->append(C)Ljava/lang/StringBuffer;

    invoke-virtual {v15}, Lcom/samsung/android/livetranslation/text/SceneText;->getValue()Ljava/lang/String;
    ...
    :cond_3
    invoke-virtual {v13}, Lcom/samsung/android/livetranslation/text/SceneText;->getLanguages()Ljava/util/ArrayList;
    ...
    invoke-direct {v3, v9, v12}, Landroid/graphics/Point;-><init>(II)V
    ...
    invoke-direct {v3, v11, v10}, Landroid/graphics/Point;-><init>(II)V
    ...
    invoke-virtual {v2, v7}, Lcom/samsung/android/livetranslation/text/SceneText;->setLanguages(Ljava/util/ArrayList;)V

...
.method public attachInfo(Landroid/content/Context;Landroid/content/pm/ProviderInfo;)V
    ...
    invoke-super {p0, p1, p2}, Ls3/b;->attachInfo(Landroid/content/Context;Landroid/content/pm/ProviderInfo;)V

    invoke-virtual {p0}, Ls3/c;->secQueryGetFingerprint()Ljava/lang/String;
    ...
    iput-object p1, p0, Ls3/c;->mAuthority:Ljava/lang/String;
    ...
    iput-object p1, p0, Ls3/c;->mMatcher:Landroid/content/UriMatcher;

    iget-object p2, p0, Ls3/c;->mAuthority:Ljava/lang/String;
    ...
    iget-object p1, p0, Ls3/c;->mMatcher:Landroid/content/UriMatcher;

    iget-object p0, p0, Ls3/c;->mAuthority:Ljava/lang/String;
...
.method public call(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-virtual {p0, p3}, Ls3/c;->secQueryAvailability(Landroid/os/Bundle;)I
...
.method public getType(Landroid/net/Uri;)Ljava/lang/String;
    ...
    iget-object v0, p0, Ls3/c;->mMatcher:Landroid/content/UriMatcher;
    ...
    invoke-super {p0, p1}, Ls3/b;->getType(Landroid/net/Uri;)Ljava/lang/String;
...
.method public query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-super/range {p0 .. p5}, Ls3/b;->query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    :cond_0
    invoke-virtual {p0, v2}, Ls3/c;->secQueryVariableRawData([Ljava/lang/String;)Landroid/database/Cursor;
    ...
    :cond_3
    invoke-virtual {p0, v2, p3}, Ls3/c;->secQueryNonIndexableKeys([Ljava/lang/String;Landroid/os/Bundle;)Landroid/database/Cursor;
...
.method public bridge synthetic queryDynamicRawData([Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-super {p0, p1}, Ls3/b;->queryDynamicRawData([Ljava/lang/String;)Landroid/database/Cursor;
...
.method public bridge synthetic querySliceUriPairs()Landroid/database/Cursor;
    ...
    invoke-super {p0}, Ls3/b;->querySliceUriPairs()Landroid/database/Cursor;
...
.method public secQueryAvailability(Landroid/os/Bundle;)I
    ...
    sget-object v1, Ls3/a;->d:[Ljava/lang/String;

    invoke-virtual {p0, v1, p1}, Ls3/c;->secQueryNonIndexableKeys([Ljava/lang/String;Landroid/os/Bundle;)Landroid/database/Cursor;
    ...
    :cond_1
    sget-object p1, Ls3/a;->d:[Ljava/lang/String;

    invoke-virtual {p0, p1}, Ls3/b;->queryNonIndexableKeys([Ljava/lang/String;)Landroid/database/Cursor;

    move-result-object p1

    :goto_0
    invoke-virtual {p0, v0, p1}, Ls3/c;->a(Ljava/lang/String;Landroid/database/Cursor;)Z

...
.method public constructor <init>(Ls/j;)V
    ...
    iput-object v0, p0, Ln/m;->a:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, Ln/m;->b:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, Ln/m;->c:Landroid/graphics/Path;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Ln/m;->d:Ljava/util/ArrayList;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object p1, p0, Ln/m;->e:Ls/j;
...
.method public final a(Landroid/graphics/Path$Op;)V
    ...
    iget-object v0, p0, Ln/m;->b:Landroid/graphics/Path;

    invoke-virtual {v0}, Landroid/graphics/Path;->reset()V

    iget-object v1, p0, Ln/m;->a:Landroid/graphics/Path;

    invoke-virtual {v1}, Landroid/graphics/Path;->reset()V

    iget-object v2, p0, Ln/m;->d:Ljava/util/ArrayList;
    ...
    invoke-virtual {v5}, Ln/d;->e()Ljava/util/List;
    ...
    invoke-interface {v8}, Ln/n;->getPath()Landroid/graphics/Path;
    ...
    invoke-virtual {v9}, Lo/o;->e()Landroid/graphics/Matrix;
    ...
    :cond_6
    iget-object p0, p0, Ln/m;->c:Landroid/graphics/Path;
...
.method public final c(Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-interface {v1, p1, p2}, Ln/c;->c(Ljava/util/List;Ljava/util/List;)V
...
.method public final getPath()Landroid/graphics/Path;
    ...
    iget-object v0, p0, Ln/m;->c:Landroid/graphics/Path;

    invoke-virtual {v0}, Landroid/graphics/Path;->reset()V

    iget-object v1, p0, Ln/m;->e:Ls/j;

    iget-boolean v2, v1, Ls/j;->b:Z
    ...
    :cond_0
    sget-object v2, Ln/l;->a:[I

    iget-object v1, v1, Ls/j;->a:Ls/i;
    ...
    invoke-virtual {p0, v1}, Ln/m;->a(Landroid/graphics/Path$Op;)V

...
# virtual methods
.method public abstract doRemoteWork(Lu3/d;)Ljava/lang/Object;
...
.method public startRemoteWork()Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-virtual {v1, v2}, Lu3/a;->plus(Lu3/i;)Lu3/i;
    ...
    invoke-direct {v2, p0, v3}, Landroidx/work/multiprocess/RemoteCoroutineWorker$startRemoteWork$1;-><init>(Landroidx/work/multiprocess/RemoteCoroutineWorker;Lu3/d;)V

    const/4 p0, 0x0

    invoke-virtual {v0, v1, p0, v2}, Landroidx/concurrent/futures/SuspendToFutureAdapter;->launchFuture(Lu3/i;ZLE3/n;)Lcom/google/common/util/concurrent/ListenableFuture;

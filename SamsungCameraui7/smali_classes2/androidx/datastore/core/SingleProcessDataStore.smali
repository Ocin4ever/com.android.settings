...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "scope",
        "<init>",
        "(LE3/a;Landroidx/datastore/core/Serializer;Ljava/util/List;Landroidx/datastore/core/CorruptionHandler;LX4/E;)V",
        "transform",
        "updateData",
        ...
        "read",
        "handleRead",
        "(Landroidx/datastore/core/SingleProcessDataStore$Message$Read;Lu3/d;)Ljava/lang/Object;",
        "Landroidx/datastore/core/SingleProcessDataStore$Message$Update;",
        "update",
        "handleUpdate",
        "(Landroidx/datastore/core/SingleProcessDataStore$Message$Update;Lu3/d;)Ljava/lang/Object;",
        ...
        "callerContext",
        "transformAndWrite",
        "(LE3/n;Lu3/i;Lu3/d;)Ljava/lang/Object;",
...
.field private final data:La5/i;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "La5/i;"
        }
...
.field private final downstreamFlow:La5/V;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "La5/V;"
        }
...
.field private final file$delegate:Lq3/c;
...
.field private final produceFile:LE3/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LE3/a;"
        }
...
.method public constructor <init>(LE3/a;Landroidx/datastore/core/Serializer;Ljava/util/List;Landroidx/datastore/core/CorruptionHandler;LX4/E;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Landroidx/datastore/core/SingleProcessDataStore;->produceFile:LE3/a;
    ...
    .line 5
    iput-object p5, p0, Landroidx/datastore/core/SingleProcessDataStore;->scope:LX4/E;
    ...
    .line 7
    new-instance p4, La5/k;

    const/4 v0, 0x1

    invoke-direct {p4, p1, v0}, La5/k;-><init>(Ljava/lang/Object;I)V

    .line 8
    iput-object p4, p0, Landroidx/datastore/core/SingleProcessDataStore;->data:La5/i;
    ...
    iput-object p1, p0, Landroidx/datastore/core/SingleProcessDataStore;->file$delegate:Lq3/c;
    ...
    iput-object p1, p0, Landroidx/datastore/core/SingleProcessDataStore;->downstreamFlow:La5/V;

    .line 12
    invoke-static {p3}, Lr3/u;->c1(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    .line 17
    invoke-direct {p1, p5, p3, p4, v0}, Landroidx/datastore/core/SimpleActor;-><init>(LX4/E;LE3/k;LE3/n;LE3/n;)V
...
.method public constructor <init>(LE3/a;Landroidx/datastore/core/Serializer;Ljava/util/List;Landroidx/datastore/core/CorruptionHandler;LX4/E;ILkotlin/jvm/internal/f;)V
    .locals 6
    ...
    invoke-virtual {p3, p4}, Lu3/a;->plus(Lu3/i;)Lu3/i;

    move-result-object p3

    invoke-static {p3}, LX4/H;->b(Lu3/i;)Lc5/e;
    ...
    .line 22
    invoke-direct/range {v0 .. v5}, Landroidx/datastore/core/SingleProcessDataStore;-><init>(LE3/a;Landroidx/datastore/core/Serializer;Ljava/util/List;Landroidx/datastore/core/CorruptionHandler;LX4/E;)V
...
.method public static final synthetic access$getDownstreamFlow$p(Landroidx/datastore/core/SingleProcessDataStore;)La5/V;
    .locals 0

    iget-object p0, p0, Landroidx/datastore/core/SingleProcessDataStore;->downstreamFlow:La5/V;
...
.method public static final synthetic access$getProduceFile$p(Landroidx/datastore/core/SingleProcessDataStore;)LE3/a;
    .locals 0

    iget-object p0, p0, Landroidx/datastore/core/SingleProcessDataStore;->produceFile:LE3/a;
...
.method public static final synthetic access$transformAndWrite(Landroidx/datastore/core/SingleProcessDataStore;LE3/n;Lu3/i;Lu3/d;)Ljava/lang/Object;
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Landroidx/datastore/core/SingleProcessDataStore;->transformAndWrite(LE3/n;Lu3/i;Lu3/d;)Ljava/lang/Object;
...
.method private final createParentDirectories(Ljava/io/File;)V
    ...
    invoke-static {p1, v0}, Lkotlin/jvm/internal/n;->i(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
...
.method private final getFile()Ljava/io/File;
    ...
    iget-object p0, p0, Landroidx/datastore/core/SingleProcessDataStore;->file$delegate:Lq3/c;
...
.method private final handleRead(Landroidx/datastore/core/SingleProcessDataStore$Message$Read;Lu3/d;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Landroidx/datastore/core/SingleProcessDataStore;->downstreamFlow:La5/V;
...
.method private final handleUpdate(Landroidx/datastore/core/SingleProcessDataStore$Message$Update;Lu3/d;)Ljava/lang/Object;
    ...
    :try_start_2
    iget-object v2, p0, Landroidx/datastore/core/SingleProcessDataStore;->downstreamFlow:La5/V;
    :try_end_2
    ...
    invoke-virtual {v2}, La5/q0;->getValue()Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Landroidx/datastore/core/SingleProcessDataStore$Message$Update;->getTransform()LE3/n;

    move-result-object v2

    invoke-virtual {p1}, Landroidx/datastore/core/SingleProcessDataStore$Message$Update;->getCallerContext()Lu3/i;
    ...
    invoke-direct {p0, v2, p1, v0}, Landroidx/datastore/core/SingleProcessDataStore;->transformAndWrite(LE3/n;Lu3/i;Lu3/d;)Ljava/lang/Object;
    ...
    :goto_6
    invoke-static {p2}, Lq3/h;->a(Ljava/lang/Object;)Ljava/lang/Throwable;
    ...
    invoke-virtual {p0, p2}, LX4/v0;->S(Ljava/lang/Object;)Z
...
.method private final readAndInit(Lu3/d;)Ljava/lang/Object;
    ...
    iget-object p1, p0, Landroidx/datastore/core/SingleProcessDataStore;->downstreamFlow:La5/V;
    ...
    invoke-direct {p1, v7, p0, v2, v8}, Landroidx/datastore/core/SingleProcessDataStore$readAndInit$api$1;-><init>(Lf5/a;Lkotlin/jvm/internal/A;Lkotlin/jvm/internal/E;Landroidx/datastore/core/SingleProcessDataStore;)V
    ...
    invoke-interface {p1, v2, v0}, LE3/n;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, v6, p0}, Lf5/d;->c(Ljava/lang/Object;Lu3/d;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v6}, Lf5/d;->d(Ljava/lang/Object;)V

    iget-object p0, v0, Landroidx/datastore/core/SingleProcessDataStore;->downstreamFlow:La5/V;
...
.method private final readAndInitOrPropagateAndThrowFailure(Lu3/d;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0}, La5/q0;->i(Ljava/lang/Object;)V
...
.method private final readData(Lu3/d;)Ljava/lang/Object;
    ...
    invoke-interface {v2, p1, v0}, Landroidx/datastore/core/Serializer;->readFrom(Ljava/io/InputStream;Lu3/d;)Ljava/lang/Object;
...
.method private final readDataOrHandleCorruption(Lu3/d;)Ljava/lang/Object;
    ...
    invoke-interface {v2, p1, v0}, Landroidx/datastore/core/CorruptionHandler;->handleCorruption(Landroidx/datastore/core/CorruptionException;Lu3/d;)Ljava/lang/Object;
    ...
    invoke-virtual {v2, p1, v0}, Landroidx/datastore/core/SingleProcessDataStore;->writeData$datastore_core(Ljava/lang/Object;Lu3/d;)Ljava/lang/Object;
    ...
    :goto_5
    invoke-static {v0, p0}, Lr3/I;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V

    throw v0
.end method

.method private final transformAndWrite(LE3/n;Lu3/i;Lu3/d;)Ljava/lang/Object;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p3, p0, Landroidx/datastore/core/SingleProcessDataStore;->downstreamFlow:La5/V;

    check-cast p3, La5/q0;

    invoke-virtual {p3}, La5/q0;->getValue()Ljava/lang/Object;
    ...
    invoke-direct {v6, p1, v2, v3}, Landroidx/datastore/core/SingleProcessDataStore$transformAndWrite$newData$1;-><init>(LE3/n;Ljava/lang/Object;Lu3/d;)V
    ...
    invoke-static {p2, v6, v0}, LX4/H;->I(Lu3/i;LE3/n;Lu3/d;)Ljava/lang/Object;
    ...
    invoke-virtual {p2, p3, v0}, Landroidx/datastore/core/SingleProcessDataStore;->writeData$datastore_core(Ljava/lang/Object;Lu3/d;)Ljava/lang/Object;
    ...
    :goto_2
    iget-object p1, p1, Landroidx/datastore/core/SingleProcessDataStore;->downstreamFlow:La5/V;
    ...
    invoke-virtual {p1, p2}, La5/q0;->i(Ljava/lang/Object;)V
...
.method public getData()La5/i;
    ...
    iget-object p0, p0, Landroidx/datastore/core/SingleProcessDataStore;->data:La5/i;
...
.method public updateData(LE3/n;Lu3/d;)Ljava/lang/Object;
    ...
    invoke-direct {v0, v1}, LX4/v0;-><init>(Z)V

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, LX4/v0;->Q(LX4/l0;)V

    iget-object v1, p0, Landroidx/datastore/core/SingleProcessDataStore;->downstreamFlow:La5/V;
    ...
    invoke-direct {v2, p1, v0, v1, v3}, Landroidx/datastore/core/SingleProcessDataStore$Message$Update;-><init>(LE3/n;LX4/r;Landroidx/datastore/core/State;Lu3/i;)V

    iget-object p0, p0, Landroidx/datastore/core/SingleProcessDataStore;->actor:Landroidx/datastore/core/SimpleActor;

    invoke-virtual {p0, v2}, Landroidx/datastore/core/SimpleActor;->offer(Ljava/lang/Object;)V

    invoke-virtual {v0, p2}, LX4/v0;->z(Lu3/d;)Ljava/lang/Object;
...
.method public final writeData$datastore_core(Ljava/lang/Object;Lu3/d;)Ljava/lang/Object;
    ...
    invoke-direct {v1, p0, p2}, Landroidx/datastore/core/SingleProcessDataStore$writeData$1;-><init>(Landroidx/datastore/core/SingleProcessDataStore;Lu3/d;)V
    ...
    invoke-static {v5, p2}, Lkotlin/jvm/internal/n;->i(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v5, p1, v6, v1}, Landroidx/datastore/core/Serializer;->writeTo(Ljava/lang/Object;Ljava/io/OutputStream;Lu3/d;)Ljava/lang/Object;
    ...
    :try_start_4
    invoke-static {v2, p1}, Lr3/I;->b(Ljava/io/Closeable;Ljava/lang/Throwable;)V

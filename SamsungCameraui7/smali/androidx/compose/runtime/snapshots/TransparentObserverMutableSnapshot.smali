...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "ownsParentSnapshot",
        "<init>",
        "(Landroidx/compose/runtime/snapshots/MutableSnapshot;LE3/k;LE3/k;ZZ)V",
        "dispose",
        "()V",
        "hasPendingChanges",
        "()Z",
...
# direct methods
.method public constructor <init>(Landroidx/compose/runtime/snapshots/MutableSnapshot;LE3/k;LE3/k;ZZ)V
    .locals 2
    ...
    invoke-virtual {p1}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->getReadObserver$runtime_release()LE3/k;
    ...
    invoke-virtual {v1}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->getReadObserver$runtime_release()LE3/k;

    move-result-object v1

    :cond_1
    invoke-static {p2, v1, p4}, Landroidx/compose/runtime/snapshots/SnapshotKt;->access$mergedReadObserver(LE3/k;LE3/k;Z)LE3/k;

    move-result-object p2

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->getWriteObserver$runtime_release()LE3/k;
    ...
    invoke-virtual {v1}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->getWriteObserver$runtime_release()LE3/k;

    move-result-object v1

    :cond_3
    invoke-static {p3, v1}, Landroidx/compose/runtime/snapshots/SnapshotKt;->access$mergedWriteObserver(LE3/k;LE3/k;)LE3/k;

    move-result-object p3

    const/4 v1, 0x0

    invoke-direct {p0, v1, v0, p2, p3}, Landroidx/compose/runtime/snapshots/MutableSnapshot;-><init>(ILandroidx/compose/runtime/snapshots/SnapshotIdSet;LE3/k;LE3/k;)V
...
.method public takeNestedMutableSnapshot(LE3/k;LE3/k;)Landroidx/compose/runtime/snapshots/MutableSnapshot;
    ...
    invoke-static {p1, v0, v1, v2, v3}, Landroidx/compose/runtime/snapshots/SnapshotKt;->mergedReadObserver$default(LE3/k;LE3/k;ZILjava/lang/Object;)LE3/k;
    ...
    invoke-virtual {p0, v3, v7}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->takeNestedMutableSnapshot(LE3/k;LE3/k;)Landroidx/compose/runtime/snapshots/MutableSnapshot;
    ...
    invoke-direct/range {v4 .. v9}, Landroidx/compose/runtime/snapshots/TransparentObserverMutableSnapshot;-><init>(Landroidx/compose/runtime/snapshots/MutableSnapshot;LE3/k;LE3/k;ZZ)V
    ...
    invoke-virtual {p0, v6, v7}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->takeNestedMutableSnapshot(LE3/k;LE3/k;)Landroidx/compose/runtime/snapshots/MutableSnapshot;
...
.method public takeNestedSnapshot(LE3/k;)Landroidx/compose/runtime/snapshots/Snapshot;
    ...
    invoke-virtual {p0, v3}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->takeNestedSnapshot(LE3/k;)Landroidx/compose/runtime/snapshots/Snapshot;

    move-result-object p0

    const/4 v0, 0x1

    invoke-static {p0, p1, v0}, Landroidx/compose/runtime/snapshots/SnapshotKt;->access$createTransparentSnapshotWithNoParentReadObserver(Landroidx/compose/runtime/snapshots/Snapshot;LE3/k;Z)Landroidx/compose/runtime/snapshots/Snapshot;
    ...
    invoke-virtual {p0, p1}, Landroidx/compose/runtime/snapshots/MutableSnapshot;->takeNestedSnapshot(LE3/k;)Landroidx/compose/runtime/snapshots/Snapshot;

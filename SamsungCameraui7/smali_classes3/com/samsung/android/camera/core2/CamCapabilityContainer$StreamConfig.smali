.class public final Lcom/samsung/android/camera/core2/CamCapabilityContainer$StreamConfig;
...
.method public constructor <init>(Lcom/samsung/android/camera/core2/util/SemImageFormat;Landroid/util/Size;Z)V
    ...
    iput-object p1, p0, Lcom/samsung/android/camera/core2/CamCapabilityContainer$StreamConfig;->a:Lcom/samsung/android/camera/core2/util/SemImageFormat;
...
.method public static B([IZ)Ljava/util/ArrayList;
    ...
    :goto_2
    invoke-direct {v3, v4, v5, v6}, Lcom/samsung/android/camera/core2/CamCapabilityContainer$StreamConfig;-><init>(Lcom/samsung/android/camera/core2/util/SemImageFormat;Landroid/util/Size;Z)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    const-class v2, Lcom/samsung/android/camera/core2/CamCapabilityContainer$StreamConfig;
    ...
    :cond_1
    iget-boolean v0, p0, Lcom/samsung/android/camera/core2/CamCapabilityContainer$StreamConfig;->c:Z

    invoke-static {v0}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v0

    iget-object v1, p0, Lcom/samsung/android/camera/core2/CamCapabilityContainer$StreamConfig;->a:Lcom/samsung/android/camera/core2/util/SemImageFormat;
    ...
    iget-boolean p0, p1, Lcom/samsung/android/camera/core2/CamCapabilityContainer$StreamConfig;->c:Z

    invoke-static {p0}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object p0

    iget-object v0, p1, Lcom/samsung/android/camera/core2/CamCapabilityContainer$StreamConfig;->a:Lcom/samsung/android/camera/core2/util/SemImageFormat;
...
.method public final hashCode()I
    ...
    const-class v0, Lcom/samsung/android/camera/core2/CamCapabilityContainer$StreamConfig;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-boolean v2, p0, Lcom/samsung/android/camera/core2/CamCapabilityContainer$StreamConfig;->c:Z

    invoke-static {v2}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v2

    iget-object v3, p0, Lcom/samsung/android/camera/core2/CamCapabilityContainer$StreamConfig;->a:Lcom/samsung/android/camera/core2/util/SemImageFormat;
    ...
    const-class v3, Lcom/samsung/android/camera/core2/CamCapabilityContainer$StreamConfig;

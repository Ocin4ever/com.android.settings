...
.method public static notifyForceStart(Landroid/content/Context;)V
    ...
    invoke-static {v1, v2, p0}, Lcom/samsung/android/camera/core2/processor/util/PLog;->i(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method private static requestPermission(Landroid/content/Context;)Z
    ...
    const-string/jumbo v2, "requestPermission E"
...
.method public static requestPermissionEnabled()V
    ...
    const-string/jumbo v2, "requestPermissionEnabled E"
    ...
    const-string/jumbo v2, "requestPermissionEnabled: countDown of WaitForGppmLatch."
    ...
    :cond_0
    const-string/jumbo v2, "requestPermissionEnabled: WaitForGppmLatch is not active."
...
.method public static updateStateTo(Landroid/content/Context;Lcom/samsung/android/camera/core2/processor/gppm/GppmStateManager$GppmState;)Z
    ...
    sget-object v3, Lcom/samsung/android/camera/core2/processor/gppm/GppmStateManager;->TAG:Lcom/samsung/android/camera/core2/util/CLog$Tag;

    const-string/jumbo v4, "updateStateTo E"
    ...
    .line 2
    :try_start_0
    sget-object v4, Lcom/samsung/android/camera/core2/processor/gppm/GppmStateManager;->mGppmProvider:Lcom/samsung/android/sdk/globalpostprocmgr/GPPProviderInterface;

    invoke-virtual {v4, p0}, Lcom/samsung/android/sdk/globalpostprocmgr/GPPProviderInterface;->isGPPMDisabled(Landroid/content/Context;)Z
    ...
    invoke-virtual {v4, p0, v2}, Lcom/samsung/android/sdk/globalpostprocmgr/GPPProviderInterface;->getState(Landroid/content/Context;Ljava/lang/String;)Lcom/samsung/android/sdk/globalpostprocmgr/GPPProviderInterface$PPAppState;

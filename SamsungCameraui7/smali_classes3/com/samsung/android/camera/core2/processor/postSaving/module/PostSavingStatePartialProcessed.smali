...
# static fields
.field private static final DRAFT_IMAGE_WAIT_TIMEOUT_S:J = 0xaL
...
.field private final mGppmProcessingManagerSupplier:Ljava/util/function/Supplier;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/function/Supplier<",
            "Lcom/samsung/android/camera/core2/processor/gppm/GppmProcessingManager;",
            ">;"
        }
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    const-string v1, "PostSavingStatePartialProcessed"
...
.method public constructor <init>(Lcom/samsung/android/camera/core2/processor/postSaving/SavingInfoContainer;Lcom/samsung/android/camera/core2/processor/postSaving/module/PostSavingStateChangedCallback;Ljava/util/concurrent/locks/Condition;Ljava/util/function/Supplier;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/samsung/android/camera/core2/processor/postSaving/SavingInfoContainer;",
            "Lcom/samsung/android/camera/core2/processor/postSaving/module/PostSavingStateChangedCallback;",
    ...
    iput-object p4, p0, Lcom/samsung/android/camera/core2/processor/postSaving/module/PostSavingStatePartialProcessed;->mGppmProcessingManagerSupplier:Ljava/util/function/Supplier;
...
.method private loadImageBufferFromDraftFile()Lcom/samsung/android/camera/core2/util/ImageBuffer;
    ...
    const-string v2, "loadImageBufferFromDraftFile is failed : "
...
.method public runComplete(Lcom/samsung/android/camera/core2/util/ImageBuffer;Lcom/samsung/android/camera/core2/ExtraBundle;Ljava/util/function/Consumer;)Z
    ...
    const-string/jumbo v1, "runComplete - gppm task mode : "
    ...
    const-string/jumbo v5, "runComplete - wait for %d seconds because db operation of draft image is not performed."

    invoke-static {p3, v5, v0}, Lcom/samsung/android/camera/core2/processor/util/PLog;->i(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v5, v0, Lcom/samsung/android/camera/core2/ExtraBundle;->a:Ljava/util/concurrent/ConcurrentHashMap;

    iget-object p2, p2, Lcom/samsung/android/camera/core2/ExtraBundle;->a:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v5, p2}, Ljava/util/concurrent/ConcurrentHashMap;->putAll(Ljava/util/Map;)V

    iget-object p2, p0, Lcom/samsung/android/camera/core2/processor/postSaving/module/PostSavingStatePartialProcessed;->mDraftCond:Ljava/util/concurrent/locks/Condition;
    ...
    iget-boolean p2, p0, Lcom/samsung/android/camera/core2/processor/postSaving/module/PostSavingStatePartialProcessed;->mIsRunDraftCalled:Z
    ...
    const-string/jumbo p1, "runComplete - the waiting time for db operation of draft image is exceeded."
    ...
    :cond_0
    iget-boolean p2, p0, Lcom/samsung/android/camera/core2/processor/postSaving/module/PostSavingStatePartialProcessed;->mIsRecoveredFromRunDraft:Z

    if-eqz p2, :cond_1

    const-string/jumbo p0, "runComplete - recovery has been performed on the runDraft function So return false."
    ...
    const-string/jumbo v0, "runComplete - Exception : "
    ...
    iget-object p2, p0, Lcom/samsung/android/camera/core2/processor/postSaving/module/PostSavingStatePartialProcessed;->mGppmProcessingManagerSupplier:Ljava/util/function/Supplier;

    invoke-interface {p2}, Ljava/util/function/Supplier;->get()Ljava/lang/Object;

    move-result-object p2

    check-cast p2, Lcom/samsung/android/camera/core2/processor/gppm/GppmProcessingManager;
    ...
    const-string/jumbo p1, "runComplete - draftImageBuffer is null, so invalidate draft image from secmp db"
    ...
    invoke-virtual {p0}, Lcom/samsung/android/camera/core2/processor/postSaving/SavingInfoContainer;->getSecMpUri()Landroid/net/Uri;

    move-result-object p0

    invoke-static {p1, p0}, Lcom/samsung/android/camera/core2/processor/database/PostProcessDBHelper;->invalidateSecMp(Landroid/content/Context;Landroid/net/Uri;)Z
...
.method public runDraft(Lcom/samsung/android/camera/core2/ExtraBundle;Ljava/util/function/Supplier;Ljava/util/function/Consumer;)Z
    ...
    .line 19
    invoke-virtual {p0, p2, p1, p3}, Lcom/samsung/android/camera/core2/processor/postSaving/module/PostSavingStatePartialProcessed;->runDraft(Lcom/samsung/android/camera/core2/util/ImageBuffer;Lcom/samsung/android/camera/core2/ExtraBundle;Ljava/util/function/Consumer;)Z
...
.method public runDraft(Lcom/samsung/android/camera/core2/util/ImageBuffer;Lcom/samsung/android/camera/core2/ExtraBundle;Ljava/util/function/Consumer;)Z
    ...
    const-string/jumbo p2, "runDraft - draft image timeout, so recovery is in progress."
    ...
    const-string/jumbo v0, "runDraft - the db operation of the draft image failed, so recovery is in progress."

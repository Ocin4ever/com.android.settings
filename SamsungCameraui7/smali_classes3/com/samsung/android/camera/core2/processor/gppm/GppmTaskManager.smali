...
.method public static confirmGppmTaskType(Landroid/content/Context;Lcom/samsung/android/camera/core2/ExtraBundle;Ljava/util/concurrent/ConcurrentHashMap;III)Lcom/samsung/android/camera/core2/processor/gppm/GppmTaskType;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static/range {v2 .. v7}, Lcom/samsung/android/camera/core2/processor/gppm/GppmTaskManager;->isTaskRequiredForCurrentConfiguration(Lcom/samsung/android/camera/core2/processor/gppm/GppmTaskType;Lcom/samsung/android/camera/core2/ExtraBundle;Ljava/util/concurrent/ConcurrentHashMap;III)Z
...
.method private static isTaskRequiredForCurrentConfiguration(Lcom/samsung/android/camera/core2/processor/gppm/GppmTaskType;Lcom/samsung/android/camera/core2/ExtraBundle;Ljava/util/concurrent/ConcurrentHashMap;III)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p4, p5}, Lcom/samsung/android/camera/core2/util/DynamicShotUtils;->isPendingRequest(II)Z
    ...
    sget-object p0, Lcom/samsung/android/camera/core2/MakerPrivateKey;->F:Lcom/samsung/android/camera/core2/MakerPrivateKey;
    ...
    invoke-virtual {p1, p2}, Lcom/samsung/android/camera/core2/ExtraBundle;->a(Lcom/samsung/android/camera/core2/ExtraBundle$Key;)Ljava/lang/Object;

    move-result-object p2

    check-cast p2, Ljava/util/concurrent/ConcurrentHashMap;

    sget-object p3, Lcom/samsung/android/camera/core2/MakerPrivateKey;->L:Lcom/samsung/android/camera/core2/MakerPrivateKey;
    ...
    invoke-virtual {p1, p3}, Lcom/samsung/android/camera/core2/ExtraBundle;->a(Lcom/samsung/android/camera/core2/ExtraBundle$Key;)Ljava/lang/Object;
...
.method private static setSupportedGppmTaskTypeList(Landroid/content/Context;)V
    ...
    invoke-virtual {v3}, Lcom/samsung/android/camera/core2/processor/gppm/GppmTaskType;->getMode()I

    move-result v4

    invoke-virtual {v0, v4}, Lcom/samsung/android/sdk/globalpostprocmgr/GPPService;->isFeatureEnabled(I)Z

    move-result v4

    if-eqz v4, :cond_0

    sget-object v4, Lcom/samsung/android/camera/core2/processor/gppm/GppmTaskManager;->supportedGppmTaskTypeList:Ljava/util/List;
    ...
    const-string/jumbo v1, "setSupportedGppmTaskTypeList - gppService.initialize SsdkUnsupportedException %s"
    ...
    const-string/jumbo v2, "setSupportedGppmTaskTypeList - "

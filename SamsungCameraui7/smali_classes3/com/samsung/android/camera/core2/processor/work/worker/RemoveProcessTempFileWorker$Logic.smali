...
.method private removeProcessTempFiles()Z
    ...
    invoke-static {}, Lcom/samsung/android/camera/core2/processor/work/worker/RemoveProcessTempFileWorker;->b()Lcom/samsung/android/camera/core2/util/CLog$Tag;
    ...
    const-string/jumbo v3, "post_process_temp"
    ...
    invoke-direct {v5, p0, v6}, LM2/u;-><init>(Ljava/lang/Object;I)V
    ...
    const-string/jumbo v3, "removeProcessTempFiles : iterating files is stopped by canceled work"
    ...
    :cond_1
    :try_start_4
    filled-new-array {v5}, [Ljava/nio/file/Path;

    move-result-object v6

    invoke-static {v6}, Lcom/samsung/android/camera/core2/util/FileUtils;->deleteFiles([Ljava/nio/file/Path;)V

    new-array v6, v1, [Ljava/lang/Boolean;

    invoke-static {v5, v6}, Lcom/samsung/android/camera/core2/util/FileUtils;->deleteDirectory(Ljava/nio/file/Path;[Ljava/lang/Boolean;)V
    :try_end_4

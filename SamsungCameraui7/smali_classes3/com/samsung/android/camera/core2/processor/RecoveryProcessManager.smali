...
.method public static synthetic d(Landroid/content/Context;Ljava/util/List;Ljava/nio/file/Path;)V
    .locals 0
...
.method private static deleteDanglingImageDataFiles(Ljava/util/List;)V
    ...
    invoke-direct {v0, v1}, Lcom/samsung/android/camera/core2/processor/k;-><init>(I)V
...
.method private static deleteDanglingRealDraftFiles(Ljava/util/List;)V
    ...
    new-instance v1, Lcom/samsung/android/camera/core2/processor/k;

    const/4 v2, 0x4

    invoke-direct {v1, v2}, Lcom/samsung/android/camera/core2/processor/k;-><init>(I)V
...
.method public static deleteDanglingRecoveryFiles(Ljava/util/List;)V
    ...
    invoke-direct {v2, v1, v3}, Lcom/samsung/android/camera/core2/processor/h;-><init>(Ljava/lang/Object;I)V
...
.method private static generateRecoveryResultFilePath(Landroid/content/Context;Landroid/net/Uri;Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    invoke-static {v0}, Lcom/samsung/android/camera/core2/util/FileUtils;->extractFileExtension(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-static {p3, v0}, Lcom/samsung/android/camera/core2/util/FileUtils;->convertFileExtension(Ljava/nio/file/Path;Ljava/lang/String;)Ljava/nio/file/Path;
    ...
    invoke-static {v0}, Lcom/samsung/android/camera/core2/util/FileUtils;->regenerateFileNameIfExists(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v3, p2}, Lcom/samsung/android/camera/core2/processor/util/PLog;->i(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-static {p0, p1, v1}, Lcom/samsung/android/camera/core2/processor/database/PostProcessDBHelper;->updateToSecMpDB(Landroid/content/Context;Landroid/net/Uri;Landroid/content/ContentValues;)Z
    :try_end_0
...
.method private static getRecoveryDataPrefixMap(Ljava/util/List;)Ljava/util/Map;
    ...
    invoke-direct {v0, v1}, Lcom/samsung/android/camera/core2/processor/l;-><init>(I)V
    ...
    new-instance v2, Lcom/samsung/android/camera/core2/processor/g;
...
.method public static getRecoveryFilePathList(Landroid/content/Context;Ljava/nio/file/Path;)Ljava/util/List;
    ...
    :try_start_1
    new-instance p1, Lcom/samsung/android/camera/core2/processor/k;

    const/4 v0, 0x7

    invoke-direct {p1, v0}, Lcom/samsung/android/camera/core2/processor/k;-><init>(I)V
...
.method private static getRecoveryPrefix(Ljava/nio/file/Path;)Ljava/lang/String;
    ...
    invoke-static {p0, v0, v1}, Landroidx/compose/material/a;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static makeRecoveryProcessSequences(Landroid/content/Context;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {v1, v2}, Lcom/samsung/android/camera/core2/processor/l;-><init>(I)V
    ...
    invoke-static {p0, v3, v2}, Lcom/samsung/android/camera/core2/processor/RecoveryProcessManager$RecoveryProcessSequence;->f(Landroid/content/Context;Ljava/nio/file/Path;Ljava/nio/file/Path;)Lcom/samsung/android/camera/core2/processor/RecoveryProcessManager$RecoveryProcessSequence;
...
.method private static moveDraftImageFileToResultFilePathAndScan(Landroid/content/Context;Ljava/nio/file/Path;Ljava/nio/file/Path;)V
    ...
    new-instance p2, Lcom/samsung/android/camera/core2/processor/i;
    ...
    const-string p2, "moveDraftImageFileToResultFilePathAndScan is failed : "
...
.method public static bridge synthetic n()Lcom/samsung/android/camera/core2/util/CLog$Tag;
    .locals 1
...
.method public static bridge synthetic o()Ljava/nio/file/PathMatcher;
    .locals 1
...
.method public static bridge synthetic q(Landroid/content/Context;Ljava/nio/file/Path;)V
    .locals 0
...
.method private static recoveryAndRemoveDraftImage(Landroid/content/Context;Ljava/nio/file/Path;Ljava/nio/file/Path;Landroid/net/Uri;)V
    ...
    const-string/jumbo v1, "recoveryAndRemoveDraftImage E"
    ...
    invoke-static {p0, p3}, Lcom/samsung/android/camera/core2/processor/database/PostProcessDBHelper;->invalidateSecMp(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-static {p1, p2, v2, v1}, Lcom/samsung/android/camera/core2/util/FileUtils;->moveFile(Ljava/nio/file/Path;Ljava/nio/file/Path;Z[Ljava/nio/file/CopyOption;)Ljava/nio/file/Path;

    invoke-interface {p2}, Ljava/nio/file/Path;->toFile()Ljava/io/File;

    move-result-object v1

    invoke-static {p0, v1}, Lcom/samsung/android/camera/core2/processor/database/PostProcessDBHelper;->scanFile(Landroid/content/Context;Ljava/io/File;)V
    ...
    invoke-static {p0, v1, v2, v3}, Lcom/samsung/android/camera/core2/processor/ExternalProviderHelper;->notifyPppCompleted(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v1, "recoveryAndRemoveDraftImage : recovery is done for recoveryResultFile(%s)"
    ...
    const-string/jumbo p1, "recoveryAndRemoveDraftImage X"
    ...
    const-string/jumbo v1, "recoveryAndRemoveDraftImage X : failed : invalid realDraftImageFile(%s), %s"

    filled-new-array {p1, p2}, [Ljava/lang/Object;

    move-result-object p2

    invoke-static {v0, v1, p2}, Lcom/samsung/android/camera/core2/processor/util/PLog;->e(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static recoveryDraftImageFromSecMpDB(Landroid/content/Context;Ljava/nio/file/Path;)Z
    ...
    sget-object v3, Lcom/samsung/android/camera/core2/processor/database/PostProcessDBHelper;->SEC_MEDIA_PROVIDER_URI:Landroid/net/Uri;
    ...
    const-string/jumbo v5, "recoveryDraftImageFromSecMpDB - recovery file(%s)"

    filled-new-array {p1}, [Ljava/lang/Object;

    move-result-object v6

    invoke-static {v1, v5, v6}, Lcom/samsung/android/camera/core2/processor/util/PLog;->i(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string/jumbo v3, "recoveryDraftImageFromSecMpDB skip - secMp db sync about %s is in progress"

    filled-new-array {p1}, [Ljava/lang/Object;

    move-result-object p1

    invoke-static {v2, v3, p1}, Lcom/samsung/android/camera/core2/processor/util/PLog;->i(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-interface {v4}, Ljava/nio/file/Path;->toFile()Ljava/io/File;

    move-result-object p1

    invoke-static {p0, p1}, Lcom/samsung/android/camera/core2/processor/database/PostProcessDBHelper;->scanFile(Landroid/content/Context;Ljava/io/File;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public static recoveryDraftImageWithoutRecoveryData(Landroid/content/Context;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {v1, v2, p0, v0}, Lcom/samsung/android/camera/core2/processor/j;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    const-string/jumbo v1, "recoveryDraftImageWithoutRecoveryData is failed : "

    invoke-static {v1, p0, p1}, Lco/polarr/mgcsc/e/i;->D(Ljava/lang/String;Ljava/lang/Exception;Lcom/samsung/android/camera/core2/util/CLog$Tag;)V

    :goto_0
    sget-object p0, Lcom/samsung/android/camera/core2/processor/RecoveryProcessManager;->TAG:Lcom/samsung/android/camera/core2/util/CLog$Tag;

    const-string/jumbo p1, "recoveryDraftImageWithoutRecoveryData X"

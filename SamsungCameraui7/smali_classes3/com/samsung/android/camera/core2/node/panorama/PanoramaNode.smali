...
.method public constructor <init>(Lcom/samsung/android/camera/core2/node/panorama/PanoramaNodeBase$PanoramaInitParam;Lcom/samsung/android/camera/core2/node/panorama/PanoramaNodeBase$PanoramaNodeCallback;)V
    ...
    invoke-direct {p0, v2, v0, v1}, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNodeBase;-><init>(ILcom/samsung/android/camera/core2/util/CLog$Tag;Z)V
    ...
    const-string v1, "PanoramaNode - %s, %s"
...
.method private detectPanoramaFrameDirection(Lcom/samsung/android/panorama/SelectFrames;)Z
    ...
    const-string/jumbo v2, "processCapture - max unknown direction count is reached"
    ...
    const-string/jumbo v2, "processCapture - unknown lib direction(%d) is detected"

    invoke-static {v1, v2, p1}, Lcom/samsung/android/camera/core2/util/CLog;->e(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v2, v3, p1}, Lcom/samsung/android/camera/core2/util/CLog;->i(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private isPanoramaCaptureErrorDetected(I)Z
    ...
    invoke-static {v3, v4}, Lcom/samsung/android/camera/core2/util/CLog;->w(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "processCapture - [lib warning] trace little quick!"
    ...
    const-string/jumbo v2, "processCapture - [lib warning] trace direction fail!"
    ...
    const-string/jumbo v0, "processCapture - max error count is reached"
    ...
    const-string/jumbo v0, "processCapture - [lib error] trace direction back fail!"
    ...
    const-string/jumbo v0, "processCapture - [lib error] trace no feature"
...
.method private panoramaCapture(Lcom/samsung/android/camera/core2/util/ImageBuffer;)Z
    ...
    invoke-direct {v1, v3, v4}, Lcom/samsung/android/camera/core2/util/CTimingLogger;-><init>(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;)V
    ...
    invoke-static {v3, p0}, Lcom/samsung/android/camera/core2/util/CLog;->w(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;)V
    ...
    invoke-static {v3, p1, p0}, Lcom/samsung/android/camera/core2/util/CLog;->w(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v3, v5, v2}, Lcom/samsung/android/camera/core2/util/CLog;->i(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v3, p1}, Lcom/samsung/android/camera/core2/util/CLog;->w(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;)V
    ...
    invoke-static {v3, v1, p1}, Lcom/samsung/android/camera/core2/util/CLog;->i(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private postLivePreview(Lcom/samsung/android/camera/core2/util/ImageBuffer;)V
    ...
    const-string/jumbo v3, "processLivePreview"

    invoke-direct {v1, v2, v3}, Lcom/samsung/android/camera/core2/util/CTimingLogger;-><init>(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;)V
...
.method private postUIImage(Lcom/samsung/android/panorama/UpdateUIImage;)V
    ...
    iget v0, p1, Lcom/samsung/android/panorama/UpdateUIImage;->UIWidth:I

    iget v1, p1, Lcom/samsung/android/panorama/UpdateUIImage;->UIHeight:I

    iget v2, p0, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNode;->mDirection:I
    ...
    const-string/jumbo v0, "postUIImage - direction(%d) is unknown"
    ...
    :cond_0
    iget v2, p0, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNode;->mPreUIImageSize:I
    ...
    iget p0, p0, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNode;->mPreUIImageSize:I
    ...
    const-string/jumbo v0, "postUIImage - height(%d) is lower than preUIImageSize(%d)(may be Lib bug)"
    ...
    :cond_1
    iget-object v1, p0, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNode;->mMinUIUpdateSize:Landroid/util/Size;
    ...
    invoke-static {v2, v4}, Lcom/samsung/android/camera/core2/util/CalculationUtils;->alignUp(II)I
    ...
    iget-object v2, p0, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNode;->mMinUIUpdateSize:Landroid/util/Size;
    ...
    iget-object p0, p0, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNode;->mMinUIUpdateSize:Landroid/util/Size;
    ...
    const-string/jumbo p1, "postUIImage - height(%d) is lower than minUIUpdateSize(%d)"
    ...
    :cond_4
    :goto_0
    iget v2, p1, Lcom/samsung/android/panorama/UpdateUIImage;->UIHeight:I

    iput v2, p0, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNode;->mPreUIImageSize:I

    iget-object v2, p0, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNode;->mMaxUISize:Landroid/util/Size;
    ...
    const-string/jumbo v0, "postUIImage - width(%d) is lower than preUIImageSize(%d)(may be Lib bug)"
    ...
    :cond_6
    iget-object v0, p0, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNode;->mMinUIUpdateSize:Landroid/util/Size;
    ...
    iget p1, p1, Lcom/samsung/android/panorama/UpdateUIImage;->UIWidth:I
    ...
    const-string/jumbo p1, "postUIImage - width(%d) is lower than minUIUpdateSize(%d)"
    ...
    iget v3, p1, Lcom/samsung/android/panorama/UpdateUIImage;->UIWidth:I

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    iget v4, p1, Lcom/samsung/android/panorama/UpdateUIImage;->UIHeight:I
    ...
    const-string/jumbo v4, "postUIImage - uiImageWidth %d, uiImageHeight %d, partialWidth %d, partialHeight %d"
    ...
    iget-object v3, p0, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNode;->mInitParam:Lcom/samsung/android/camera/core2/node/panorama/PanoramaNodeBase$PanoramaInitParam;

    iget v3, v3, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNodeBase$PanoramaInitParam;->m:I
    ...
    const-string/jumbo v4, "postUIImage"

    invoke-direct {v3, v2, v4}, Lcom/samsung/android/camera/core2/util/CTimingLogger;-><init>(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;)V

    iget-object v3, p0, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNode;->mUIImageBuffer:Lcom/samsung/android/camera/core2/util/DirectBuffer;

    iget-object v4, p0, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNode;->mUIImageRgbaBuffer:Lcom/samsung/android/camera/core2/util/DirectBuffer;

    iget v5, p0, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNode;->mDirection:I

    iget v6, p1, Lcom/samsung/android/panorama/UpdateUIImage;->UIWidth:I

    iget v7, p1, Lcom/samsung/android/panorama/UpdateUIImage;->UIHeight:I
    ...
    invoke-static/range {v3 .. v12}, Lcom/samsung/android/camera/core2/util/ImageUtils;->convertPackedNV21ToRGBA_Partial(Lcom/samsung/android/camera/core2/util/DirectBuffer;Lcom/samsung/android/camera/core2/util/DirectBuffer;IIIIIZII)Z

    move-result p1

    if-nez p1, :cond_a

    const-string/jumbo p0, "postUIImage - convertPackedNV21ToRGBA_Partial fail"
    ...
    invoke-virtual {p1, v2, v0}, Lcom/samsung/android/camera/core2/util/SemImageFormat;->getBufferSize(Landroid/util/Size;Lcom/samsung/android/camera/core2/util/StrideInfo;)I
    ...
    iget-object v0, p0, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNode;->mUIImageRgbaBuffer:Lcom/samsung/android/camera/core2/util/DirectBuffer;
    ...
    invoke-interface {p0, p1}, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNodeBase$PanoramaNodeCallback;->onPanoramaUIImageData([B)V
...
.method private saveThumbnail(Lcom/samsung/android/camera/core2/util/ImageBuffer;)Z
    ...
    invoke-direct {v3, v0, v1}, Lcom/samsung/android/camera/core2/util/CTimingLogger;-><init>(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;)V
...
.method public cancelCapture()V
    ...
    invoke-direct {v2, v0, v1}, Lcom/samsung/android/camera/core2/util/CTimingLogger;-><init>(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;)V
...
.method public onDeinitialized()V
    ...
    invoke-direct {v3, v1, v2}, Lcom/samsung/android/camera/core2/util/CTimingLogger;-><init>(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;)V
    ...
    :cond_1
    :goto_1
    iget-object v1, p0, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNode;->mBufferDeque:Lcom/samsung/android/camera/core2/util/BufferDeque;
    ...
    iput-object v1, p0, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNode;->mBufferDeque:Lcom/samsung/android/camera/core2/util/BufferDeque;

    :cond_2
    iget-object v1, p0, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNode;->mPreviewTaskFutures:Ljava/util/List;
...
.method public onInitialized(Ljava/util/Map;)V
    ...
    invoke-direct {v3, v0, v2}, Lcom/samsung/android/camera/core2/util/CTimingLogger;-><init>(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;)V
...
.method public startCapture()V
    ...
    invoke-static {v0, v4, v6}, Lcom/samsung/android/camera/core2/util/CLog;->v(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance v4, Lcom/samsung/android/camera/core2/node/panorama/PanoramaNode$DebugCTimingLogger;

    invoke-direct {v4, v0, v1}, Lcom/samsung/android/camera/core2/util/CTimingLogger;-><init>(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;)V

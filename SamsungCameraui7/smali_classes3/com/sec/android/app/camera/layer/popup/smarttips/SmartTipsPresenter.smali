...
.method private getZoomLockTipsBottomMargin(I)I
    .locals 4
    ...
    sget-object p1, Lw1/g;->BOTTOM_GUIDE_LINE:Lw1/g;
    ...
    invoke-interface {p0}, Lcom/sec/android/app/camera/interfaces/ZoomManager;->getZoomTextVisibleRect()Landroid/graphics/Rect;
...
.method private handleLinkAction()V
    ...
    sget-object p0, Lcom/sec/android/app/camera/interfaces/SaLogEventId;->LOG_VIDEO_TIPS_TAB:Lcom/sec/android/app/camera/interfaces/SaLogEventId;
...
.method private handleShootingModeLinkAction(Lcom/sec/android/app/camera/interfaces/CommandId;)V
    ...
    invoke-static {p1, v0, v1}, Ln2/q;->a(Lcom/sec/android/app/camera/interfaces/CommandId;Lcom/sec/android/app/camera/interfaces/CommandReceiverManager;Ljava/lang/Object;)Ln2/x;
...
.method public onRadioButton1Click()V
    ...
    invoke-static {v4, v0}, Ln2/r;->b(ILcom/sec/android/app/camera/interfaces/CameraSettings$Key;)Lcom/sec/android/app/camera/interfaces/CommandId;

    move-result-object v0

    iget-object v1, p0, Lcom/sec/android/app/camera/layer/popup/abstraction/AbstractPopupPresenter;->mCameraContext:Lcom/sec/android/app/camera/interfaces/CameraContext;

    invoke-static {v1, v0, v3}, Lcom/sec/android/app/camera/engine/core/request/a;->y(Lcom/sec/android/app/camera/interfaces/CameraContext;Lcom/sec/android/app/camera/interfaces/CommandId;Ljava/lang/Object;)Z
    ...
    invoke-interface {v0, v5}, Lcom/sec/android/app/camera/layer/popup/smarttips/SmartTipsContract$View;->setSelectedRadioButton(Z)V
    ...
    const-string/jumbo v0, "pref_key_selfie_tone_tips_after_capture"

    invoke-static {p0, v0, v5}, Lcom/sec/android/app/camera/util/SharedPreferencesHelper;->savePreferences(Landroid/content/Context;Ljava/lang/String;Z)V
...
.method public onRadioButton2Click()V
    ...
    invoke-static {p0, v0, v3}, Lcom/sec/android/app/camera/util/SharedPreferencesHelper;->savePreferences(Landroid/content/Context;Ljava/lang/String;Z)V
...
.method public onUpdateLayout(III)V
    ...
    invoke-direct {p0, p3}, Lcom/sec/android/app/camera/layer/popup/smarttips/SmartTipsPresenter;->getZoomLockTipsBottomMargin(I)I
    ...
    check-cast p1, Lcom/sec/android/app/camera/layer/popup/smarttips/SmartTipsContract$View;
    ...
    invoke-interface {p1, p0}, Lcom/sec/android/app/camera/layer/popup/smarttips/SmartTipsContract$View;->updateBackground(I)V

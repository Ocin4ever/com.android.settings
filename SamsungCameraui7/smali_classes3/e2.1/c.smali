...
.method public constructor <init>(Landroid/content/Context;LZ1/b;)V
    ...
    invoke-static {p1}, Lb2/a;->m(Landroid/content/Context;)Lb2/a;

    move-result-object p1

    iput-object p1, p0, Le2/c;->e:Lb2/a;
...
.method public final c(Ljava/util/Map;)I
    ...
    invoke-static {v4, v5}, Lcom/bumptech/glide/c;->c(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_2

    :cond_2
    invoke-static {v0}, Lcom/bumptech/glide/c;->z(Landroid/content/Context;)Z
    ...
    :goto_2
    iget-object v4, p0, Lcom/samsung/context/sdk/samsunganalytics/internal/sender/a;->c:Lg2/a;
    ...
    iget-object p1, p0, Lcom/samsung/context/sdk/samsunganalytics/internal/sender/a;->b:LZ1/b;

    iget-object v1, p0, Lcom/samsung/context/sdk/samsunganalytics/internal/sender/a;->d:Lc0/g;

    iget-object p0, p0, Le2/c;->e:Lb2/a;

    const/4 v3, 0x0

    invoke-static {v0, p1, v1, p0, v3}, Lcom/bumptech/glide/c;->M(Landroid/content/Context;LZ1/b;Lc0/g;Lb2/a;LZ1/e;)V

    iget-boolean p0, v4, Lg2/a;->a:Z

    if-eqz p0, :cond_4

    iget-object p0, v4, Lg2/a;->b:Ljava/lang/Object;
    ...
    invoke-static {v0, v1, p1}, LG1/a;->j(JLjava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v0, p0, v1}, Le2/b;-><init>(Le2/c;I)V
    ...
    invoke-virtual {p0, p1}, Le2/c;->d(Ljava/util/Map;)Ljava/util/Map;

    sget-object v3, Lk2/c;->ONE_DEPTH:Lk2/c;

    invoke-static {p1, v3}, LU4/q;->K(Ljava/util/Map;Lk2/c;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v2, v0}, Le2/c;->f(ILcom/samsung/context/sdk/samsunganalytics/internal/sender/d;Le2/b;)I
    ...
    invoke-virtual {v4, v3}, Lg2/a;->b(I)Ljava/util/concurrent/LinkedBlockingQueue;

    move-result-object v3

    iget-boolean v4, v4, Lg2/a;->a:Z
    ...
    invoke-virtual {p0, v1, v2, v3, v0}, Le2/c;->e(ILcom/samsung/context/sdk/samsunganalytics/internal/sender/b;Ljava/util/concurrent/LinkedBlockingQueue;Le2/b;)V
    ...
    invoke-virtual {p0, v1, p1, v0}, Le2/c;->f(ILcom/samsung/context/sdk/samsunganalytics/internal/sender/d;Le2/b;)I
...
.method public final d(Ljava/util/Map;)Ljava/util/Map;
    ...
    iget-object v0, p0, Le2/c;->e:Lb2/a;

    iget-object v1, v0, Lb2/a;->a:Ljava/lang/Object;
    ...
    iget-object v1, v0, Lb2/a;->e:Ljava/lang/Object;
    ...
    iget-object v1, p0, Lcom/samsung/context/sdk/samsunganalytics/internal/sender/a;->b:LZ1/b;
    ...
    iget-object p0, v1, LZ1/b;->c:Ljava/lang/String;
    ...
    iget-object p0, v1, LZ1/b;->a:Ljava/lang/String;
...
.method public final e(ILcom/samsung/context/sdk/samsunganalytics/internal/sender/b;Ljava/util/concurrent/LinkedBlockingQueue;Le2/b;)V
    .locals 9
    ...
    invoke-static {v3}, Lcom/bumptech/glide/d;->q(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    iget-object v7, p0, Lcom/samsung/context/sdk/samsunganalytics/internal/sender/a;->c:Lg2/a;
    ...
    invoke-virtual {v7, v0}, Lg2/a;->f(Ljava/util/ArrayList;)V

    const/16 p3, 0xc8

    invoke-virtual {v7, p3}, Lg2/a;->b(I)Ljava/util/concurrent/LinkedBlockingQueue;
    ...
    invoke-static {v3, p1, v6}, Lcom/bumptech/glide/c;->N(Landroid/content/Context;II)V

    new-instance v3, Le2/a;

    iget-object v4, p0, Lcom/samsung/context/sdk/samsunganalytics/internal/sender/a;->b:LZ1/b;

    iget-object v4, v4, LZ1/b;->a:Ljava/lang/String;

    invoke-direct {v3, p2, v2, v4, p4}, Le2/a;-><init>(Lcom/samsung/context/sdk/samsunganalytics/internal/sender/b;Ljava/util/concurrent/LinkedBlockingQueue;Ljava/lang/String;Le2/b;)V

    iget-object v4, p0, Lcom/samsung/context/sdk/samsunganalytics/internal/sender/a;->d:Lc0/g;
    ...
    invoke-static {v3, v2}, Lcom/bumptech/glide/c;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final f(ILcom/samsung/context/sdk/samsunganalytics/internal/sender/d;Le2/b;)I
    .locals 10
    ...
    invoke-static {v3, v5, v6, v7, v8}, LG1/a;->m(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v6}, Lcom/bumptech/glide/c;->e(Ljava/lang/String;)V
    ...
    invoke-static {v3, v5, v2, v6, v8}, LG1/a;->m(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v9, v2}, Lcom/bumptech/glide/c;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v2, v0, v3, v8, v7}, LG1/a;->g(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_5
    invoke-static {v1, p1, v0}, Lcom/bumptech/glide/c;->N(Landroid/content/Context;II)V
    ...
    invoke-direct {p1, p2, v0, p3}, Le2/a;-><init>(Lcom/samsung/context/sdk/samsunganalytics/internal/sender/d;Ljava/lang/String;Le2/b;)V

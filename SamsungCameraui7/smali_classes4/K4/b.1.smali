...
.method public constructor <init>(LJ4/o;)V
    ...
    invoke-direct {p0, p1}, LK4/j;-><init>(LJ4/o;)V
...
.method public final c()LK4/y;
    ...
    invoke-virtual {p0}, LK4/b;->m()LU3/f;
    ...
    sget-object v2, LR3/n;->a:Lt4/e;

    invoke-static {v0, v2}, LR3/i;->b(LU3/i;Lt4/e;)Z

    move-result v2

    if-nez v2, :cond_1

    sget-object v2, LR3/n;->b:Lt4/e;
    ...
    :cond_0
    invoke-virtual {p0}, LK4/b;->f()LR3/i;
...
.method public bridge synthetic g()LU3/i;
    .locals 0
...
.method public abstract m()LU3/f;
.end method

...
.method public final a(Lt4/c;)La4/e;
    ...
    invoke-virtual {p0}, La4/w;->b()Ljava/lang/reflect/Member;
...
.method public final d([Ljava/lang/reflect/Type;[[Ljava/lang/annotation/Annotation;Z)Ljava/util/ArrayList;
    ...
    invoke-direct {v6, v5, v3}, La4/a;-><init>(Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;)V
    ...
    invoke-direct {v6, v4, v4}, La4/a;-><init>(Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;)V

    :goto_0
    sput-object v6, La4/b;->b:La4/a;
    :try_end_2
    ...
    :cond_1
    :goto_3
    iget-object v1, v3, La4/a;->a:Ljava/lang/reflect/Method;
    ...
    :cond_2
    iget-object v3, v3, La4/a;->b:Ljava/lang/reflect/Method;
    ...
    new-instance v7, La4/z;

    invoke-direct {v7, v9}, La4/z;-><init>(Ljava/lang/Class;)V
    ...
    invoke-direct {v8, v7}, La4/E;-><init>(Ljava/lang/reflect/WildcardType;)V
    ...
    invoke-direct {v8, v7}, La4/q;-><init>(Ljava/lang/reflect/Type;)V
    ...
    invoke-direct {v8, v7}, La4/i;-><init>(Ljava/lang/reflect/Type;)V
    ...
    invoke-static {v8, v2}, Lr3/u;->E0(ILjava/util/List;)Ljava/lang/Object;
    ...
    invoke-direct {v9, v7, v11, v8, v10}, La4/D;-><init>(La4/B;[Ljava/lang/annotation/Annotation;Ljava/lang/String;Z)V
...
.method public final e()LU3/k0;
    ...
    sget-object p0, LU3/h0;->c:LU3/h0;
    ...
    sget-object p0, LY3/c;->c:LY3/c;

    goto :goto_0

    :cond_2
    sget-object p0, LY3/b;->c:LY3/b;

    goto :goto_0

    :cond_3
    sget-object p0, LY3/a;->c:LY3/a;
